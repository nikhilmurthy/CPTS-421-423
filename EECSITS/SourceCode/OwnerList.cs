    ...
    public partial class frmListOwner : Form
    {
        ...
        public void load_datagrid()
        {
            ...
            while (i < rc)
            {
                ...
                dataGridView1.Rows[i].Cells[5].Value = la_owner[8][i];
                dataGridView1.Rows[i].Cells[6].Value = la_owner[7][i];
                i++;
            }
        ...
        private void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (btn.Name == "btnExportCSV")
                rmsg = Global.exportToCsvFile(dataGridView1, "OwnerList", "");
            else
                rmsg = Global.exportToPdfFile(dataGridView1, "OwnerList", "");
